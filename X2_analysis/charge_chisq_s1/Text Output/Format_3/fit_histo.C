...
//  f_open.open("241Am.dat"); //open the file
  f_open.open("/Users/josephmammo/Desktop/Fall 2019/MINER Data Analysis/AmBe_iZIP_NISER/charge_chisq_s1/Text Output/Format_3/project_Qchisq0_39.dat"); //open the file
  int x_val;
